...
public class JacksonHranaJsonCodecTest {

    private final JacksonHranaJsonCodec codec = new JacksonHranaJsonCodec();

    @Test
    void testSerializePipelineRequestOneShot() throws IOException {
        Stmt stmt = new Stmt("SELECT ? as num, ? as greeting", List.of(Value.of(9223372036854775807L), Value.of("hello")));
